...
class PortfolioBloc extends Bloc<PortfolioEvent, PortfolioState> {
  ...
  Stream<PortfolioState> refreshAllLists() async* {
    ...
    int totalScore = 0;
    int considering = 0;
    _applicationList.forEach((element) {
      if (element.status == "created" && element.ammount != null) {
        considering = considering + element.ammount;
      }
    });
