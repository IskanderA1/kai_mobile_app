...
const String activityOfferInformation = "Дорогой студент! Если в списке активностей нет твоего мероприятия, ты можешь помочь нам  улучшить приложение. Заполни простую форму, модератор ее проверит, и вскоре твое мероприятие будет включено в список. Обещаем!";
